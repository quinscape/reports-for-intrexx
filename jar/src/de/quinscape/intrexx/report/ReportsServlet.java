...
import de.quinscape.intrexx.report.domain.ExportTarget;
import de.quinscape.intrexx.report.domain.Exporter;
import de.quinscape.intrexx.report.domain.ReportService;
    ...
    implements IIxServlet, ExportTarget
{
      ...
      IServerBridgeRequest request, IServerBridgeResponse response)
  {
    ...
    {
      // TODO Unter welchen Umständen wird dieser Zweig aufgerufen? Was muss dann als ApplicationContext (1. Parameter) angegeben werden?
