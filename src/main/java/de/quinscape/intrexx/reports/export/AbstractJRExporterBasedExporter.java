    ...
    implements Exporter, InitializingBean
{
  ...
  public final void export(ReportContext context, JasperPrint print, OutputStream target)
  {
    ...
    try
    {
      ...
      if(hyperlinkProducerFactory != null)
        ((SimpleReportExportConfiguration)reportConfig).setHyperlinkProducerFactory(
  ...
  /**
   * Erzeugt {@link SimpleExporterInput} für ein {@link JasperPrint}.
   * 
   * @param print
   *          Das {@link JasperPrint}, für den der Input erzeugt werden soll.
   * @return Der erzeugte {@link SimpleExporterInput}.
   */
