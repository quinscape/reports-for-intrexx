...
import de.quinscape.intrexx.reports.domain.ReportCreationResult;
import de.quinscape.intrexx.reports.domain.ReportsRepository;
import de.quinscape.intrexx.reports.domain.VelocityReportCreator;
...
public final class ReportsProvider
{
   ...
   */
  public IntrexxApplicationReport findReport(
      ...
      IBusinessLogicProcessingContext context, String reportIdentifier)
  {
    ...
    IntrexxApplicationReport report = findReport(context, reportIdentifier);
    if(report != null)
    {
